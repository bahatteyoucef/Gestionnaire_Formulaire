...
<div class="card" id="form_card" class="slide-in-right">
  <div class="card-body">
    ...
    <table class="table table-borderless" id="mobile_divs">
      ...
      <thead>
        <tr>
          <th scope="col" style="height:0px !important;padding:0px !important;width: 50%" class="text-center table-mobile-view"></th>
          <th scope="col" style="height:0px !important;padding:0px !important;width: 50%" class="text-center table-mobile-view"></th>
        </tr>
      </thead>
      ...
      <tbody>
        ...
        <tr>
          <td class="text-center" style="width: 50%;padding-bottom:0px !important;">
          ...
          <td class="text-center" style="width: 50%;width: 50%;padding-bottom:0px !important;">
