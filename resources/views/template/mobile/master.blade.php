...
<head>
    ...
    <link rel="stylesheet" href="{{url('css/emojis.css')}}">
    <!--  -->
...
<body>
    <div class="container-scroller">
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            @include('template/mobile/sidebar/sidebar')
            <!-- partial -->
            ...
            <div class="main-panel">
                ...
                <!-- partial:partials/_sidebar.html -->
                @include('template/mobile/main/main')
                <!-- partial -->

                <!-- partial:partials/_footer.html -->
                @include('template/mobile/footer/footer')
            </div>
            <!-- partial -->
