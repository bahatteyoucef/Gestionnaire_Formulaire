...
<div class="content-wrapper">
    <div class="card">
        <div class="card-body">
            ...
            <form class="forms-sample" method="POST" action="{{route('formulaires.store')}}">
                {{ csrf_field() }}
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="description_formulaire" id="description_formulaire"></textarea>
                </div>
