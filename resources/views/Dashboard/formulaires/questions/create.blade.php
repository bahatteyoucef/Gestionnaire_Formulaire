...
<div class="content-wrapper">
    <div class="card">
        <div class="card-body">
            ...
            <form class="forms-sample" method="POST" action="{{route('formulaire_questions.store',$formulaire->id_formulaire)}}">
                {{ csrf_field() }}
                ...
                <div class="form-group">
                    ...
                    <div class="div-btn-groupe">
                        ...
                        <input type="text" name="id_groupe_value" id="id_groupe_value" hidden>
                        <div id="dropdown-menu-groupe" class="dropdown-menu-groupe dropdown-menu w-100, mt-0" 
                        aria-labelledby="id_groupe">
...
<script src="{{ URL::asset('/Js/AddOptions.js') }}"></script>
